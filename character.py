...
switch_img = pygame.image.load('imgs_updated/UnoReverse.png').convert_alpha()
...
choose = static.Static(-25, -80, choose_img, 100, 100)
astr1 = button.Button(4, 80, nelson_img, 100, 100)
astr2 = button.Button(4, 170, yuri_img, 100, 100)
astr3 = button.Button(4, 260, buzz_img, 100, 100)
switch = button.Button(680, 450, switch_img, 100, 100)
